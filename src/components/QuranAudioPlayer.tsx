...
const QuranAudioPlayer = ({ audioUrl, surahName, isPlaying, onTogglePlay }: QuranAudioPlayerProps) => {
  if (!isPlaying || !audioUrl) return null;
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 bg-background border rounded-lg shadow-lg p-3 flex items-center gap-3 max-w-xs animate-in fade-in slide-in-from-bottom-5">
      ...
      <Button size="sm" variant="ghost" onClick={onTogglePlay} className="h-8 w-8 p-0 rounded-full">
